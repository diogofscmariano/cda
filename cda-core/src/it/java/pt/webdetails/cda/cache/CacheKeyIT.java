...
import pt.webdetails.cda.CdaTestEnvironment;
import pt.webdetails.cpf.repository.api.CdaTestingContentAccessFactory;

import javax.swing.table.TableModel;

public class CacheKeyIT extends CdaTestCase {
  ...
  private static final Log logger = LogFactory.getLog( CacheKeyIT.class );
